      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-8 text-lg md:text-xl text-gray-300 leading-relaxed">
          ...
          >
            ...
            <span>
              Hace más de 25 años, este sistema fue desarrollado en secreto por un genio matemático para un círculo exclusivo de la élite financiera. Pagaron más de $499 USD por este conocimiento, diseñado para explotar las vulnerabilidades estadísticas del Baccarat y asegurar una ventaja inquebrantable.
            </span>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
